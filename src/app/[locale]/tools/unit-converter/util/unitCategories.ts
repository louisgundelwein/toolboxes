...
export type SpeedUnit = 'meter-per-second' | 'kilometer-per-hour' | 'mile-per-hour' | 'knot';
...
export function getSimpleUnitCategory(t: ReturnType<typeof useTranslations>): SimpleUnitCategory[] {
  return [
    {
      key: 'length',
      ...
      return {
        ...
        units: {
          'cubic-meters-per-second': {
            ...
            definition: t('units.volume-flow.cubic-meters-per-second.definition'),
      ...
      return {
        ...
        units: {
          'meters-per-second-squared': {
            ...
            definition: t('units.acceleration.meters-per-second-squared.definition'),
          ...
          'feet-per-second-squared': {
            ...
            definition: t('units.acceleration.feet-per-second-squared.definition'),
      ...
      return {
        ...
        units: {
          'kilogram-per-square-meter': {
            ...
            definition: t('units.area-density.kilogram-per-square-meter.definition'),
          ...
          'gram-per-square-centimeter': {
            ...
            definition: t('units.area-density.gram-per-square-centimeter.definition'),
